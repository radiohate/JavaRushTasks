...
//строку формата "name(имя части тела) содержит кости", если метод containsBones() возвращает "Yes"
// для этой части тела. Если "No", то строку формата "name(имя части тела) не содержит кости".
...
//Метод containsBones() в классе Finger должен возвращать строку "Yes", если такой же метод в
// классе BodyPart возвращает "Yes" и флаг isArtificial равен false.
// Если приведенное условие не выполняется -
// вернуть "No".
        public Object containsBones() {
            //return super.containsBones() && !isArtificial;
            String returnStr;
            if(super.containsBones().equals("Yes") && isArtificial == false) returnStr = "Yes";
            else returnStr = "No";
            return returnStr;
        }
    }
